...
from utilities.configs import SUPPORTED_LIBRARIES, FACE_RECOGNITION_SUPPORTED_MODELS, DEEPFACE_SUPPORTED_BACKENDS_DETECTORS, DEEPFACE_SUPPORTED_MODELS, INSIGHTFACE_SUPPORTED_MODELS
...
def main_content():
    ...
    with view_dataset:
        ...
        This gallery showcases every individual who has been added to the system, including their profile images and metadata. Use this section to review, organize, or remove entries, and to ensure your recognition model remains up-to-date and relevant.
        """)
